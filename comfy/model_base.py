...
class MiniMaxH3(BaseModel):
    ...
    def extra_conds(self, **kwargs):
        ...
        # each keyframe/ref carries its own "aug" (noise-blend strength); None lets
        # model.py fall back to that kind's builtin default (VISUAL_/AUDIO_COND_TIMESTEP)
        ...
        if keyframes is not None:
            ...
            payload["cond_video_items"] = [(kf["latent"], kf.get("aug")) for kf in keyframes if "latent" in kf]
